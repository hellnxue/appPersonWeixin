...
<%@include file="/WEB-INF/jsp/common/taglibs.jspf" %>
		...
		<c:forEach items="${content}" var="news">
            <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
              <div class="am-u-sm-3 am-list-thumb"> <a href="${ctx}/webApp/news/msgDetail?id=${news.id}" class=""> <img src="${ctx}/static/assets/images/img1.jpg" alt="${news.title==""?"无题":news.title}" class="am-radius" /><em class="am-round"></em> </a> </div>
