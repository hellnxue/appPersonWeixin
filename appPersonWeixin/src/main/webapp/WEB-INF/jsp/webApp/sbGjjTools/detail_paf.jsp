   ...
   console.log(resultObj);
     ...
     function init(obj){
    	 ...
    	 if(obj&&obj.code==1){
    		 ...
    		 console.log(Name);
    		 var accountStatus=dataObj.accountStatus;
    		 var openDate=dataObj.openDate;
    		 var company=dataObj.company;
    		 var RemainSum=dataObj.RemainSum;
    		 var lastMonth=dataObj.lastMonth;
    		 var monthlyPayment=dataObj.monthlyPayment;
    		 
    		 var $basicEmSelector=$(".detail-basic dd");
    		 $basicEmSelector.eq(0).find("strong").html(Name);
    		 $basicEmSelector.eq(1).find("em").html(accountStatus);
    		 $basicEmSelector.eq(2).find("em").html(openDate.substring(0,8));
    		 $basicEmSelector.eq(3).find("em").html(company);
    		 $basicEmSelector.eq(4).find("em").html(RemainSum);
    		 $basicEmSelector.eq(5).find("em").html(lastMonth.substring(0,8));
    		 $basicEmSelector.eq(6).find("em").html(monthlyPayment);
    		 
    		 var date=new Date();
    		 var curYear=String(date.getFullYear());
    		 var curMth=Number(date.getMonth()+1);
    		 var chargeListObj=dataObj.ChargeList;
    		 var yearDataArray=dataObj.ChargeList[curYear];
    		 
    		 console.log("yearDataArray="+yearDataArray);
