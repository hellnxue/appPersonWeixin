...
public class HrHelperFileUploader {
	...
	public static final String serverUrl = Config.getHroUrl();
	...
	public static void main(String[] args) {
		Map<String, Object>  realUrl = upload("D:\\Hydrangeas.jpg");
		System.out.println(realUrl);
		//System.out.println(upload("D://repository//appPersonWeiXin//src//main//webapp//static//weixinnews//2016//5//24//test211.html"));
