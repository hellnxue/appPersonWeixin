...
<div data-am-widget="tabs" class="am-tabs am-tabs-d2 nomargin page_tab">
  <ul class="am-tabs-nav am-cf">
    <li class="am-active"> <a href="[data-tab-panel-0]">公司通告<em class="am-round"></em></a> </li>
    ...
    <div data-tab-panel-0 class="am-tab-panel am-active">
      <div data-am-widget="list_news" class="am-list-news am-list-news-default nomargin">
        <div class="am-list-news-bd">
          <ul class="am-list">
            <!--缩略图在标题左边-->
	          <c:set value="${news.resultData}" var="content" />
			<%@include file="/WEB-INF/jsp/webApp/news/companymsg.jsp" %>   
          </ul>
        </div>
      </div>
    </div>
