...
<link rel="stylesheet" href="${ctx}/static/assets/css/app.css">
   ...
   <body   style="background:url(${ctx}/static/assets/images/loginygbg.jpg) no-repeat;background-size:100%;height:100%;width:100%;-moz-background-size:100%;-webkit-background-size:100%;-o-background-size:100%;">
