...
final class SimpleJpaQuery extends AbstractJpaQuery {
    ...
    /**
     * Creates a new {@link SimpleJpaQuery} encapsulating the query annotated on the given {@link org.springframework.data.jpa.repository.query.JpaQueryMethod}.
     */
    ...
    public static RepositoryQuery fromQueryAnnotation(JpaQueryMethod queryMethod, EntityManager em) {
    	...
    	LOG.info("Looking up query for method {}", queryMethod.getName());
