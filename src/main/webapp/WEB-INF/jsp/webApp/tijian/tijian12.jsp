	   ...
	   userid:"${userid}"
		...
		function (data) {
	        ...
	        // var jigouName=data.FILE_PATH;				//机构（暂无）
	         ...
	         var userName=data.USER_NAME;					//体检人
	         
	         var age=data.age;								//年龄
	         var gender=data.GENDER==0?"男":"女";			//性别
	         var cardNum=data.CARD_NUM;						//卡号
	         var receivingName=data.RECEIVING_NAME;			//报告接收人
	         var detailedAddr=data.DETAILED_ADDR;			//报告接收地址
	         ...
	         var mobile=data.MOBILE;   //体检人手机号码
	         var receivingMobile=data.MOBILE_PHONE;   //提交报告收取人的手机号码
