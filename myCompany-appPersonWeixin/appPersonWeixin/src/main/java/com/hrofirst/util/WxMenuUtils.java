	...
	public static void hrMenu() {
		...
		try {
			...
			s = "{\"button\":["
					...
					+ "{\"type\":\"view\",\"name\":\"福利兑换\",\"url\":\"http://shopzy.ezhiyang.com/shop/themeActivity/wx/exchange.jhtml\",\"sub_button\":[]}"
	...
	public static void personMenu() {
		...
		try {
			...
			s = "{\"button\":["
					...
					+"{\"type\":\"view\",\"name\":\"理赔申请\",\"url\":\"http://www.formtalk.net/pub.do?f=6AAA7BEF8619B253092EA7922701CC6AB3C0435A00E1399A5697058C98477B32\",\"sub_button\":[]},"
...
//					+ "{\"type\":\"click\",\"name\":\"上传资料\",\"key\":\"uploadFiles\",\"sub_button\":[]}"
	...
	public static void personMenuCeShi() {
		...
		try {
			String accessToken = getAccessToken("wxf8fc9a730a1c3dce",
					"068f68b70f70e3dda0e54cd12730f2f9");
			...
			// 员工帮手
			s = "{\"button\":["
					+ "{\"type\":\"view\",\"name\":\"登录\",\"url\":\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf8fc9a730a1c3dce&redirect_uri=http%3A%2F%2FbakPR.hrofirst.com%2FwebApp%2FweixinPerson&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect\",\"sub_button\":[]},"
					...
					+ "{\"name\":\"员工服务\",\"sub_button\":["
					+"{\"type\":\"view\",\"name\":\"理赔申请\",\"url\":\"http://www.formtalk.net/pub.do?f=00FEDD9F6F5C19FDE749C3EA1EAD61AACA75E0FC7A0435635697058C98477B32\",\"sub_button\":[]},"
					+ "{\"type\":\"view\",\"name\":\"移动签到\",\"url\":\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf8fc9a730a1c3dce&redirect_uri=http%3A%2F%2Fappperson.ezhiyang.com%2FwebApp%2FweixinPersonSignIn&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect\",\"sub_button\":[]},"
//					+ "{\"type\":\"click\",\"name\":\"上传资料\",\"key\":\"uploadFiles\",\"sub_button\":[]}"
//					+ "{\"type\":\"view\",\"name\":\"上传资料\",\"url\":\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf8fc9a730a1c3dce&redirect_uri=http%3A%2F%2Fappperson.ezhiyang.com%2FwebApp%2Fuser%2dataUpload&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect\",\"sub_button\":[]},"
					+ "{\"type\":\"view\",\"name\":\"上传资料\",\"url\":\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf8fc9a730a1c3dce&redirect_uri=http%3A%2F%2FbakPR.hrofirst.com%2FwebApp%2Fuser%2FdataUpload&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect\",\"sub_button\":[]},"
