...
<body style="background-color: white">
 ...
 <div class="add-address-edit">
  <ul class="am-list am-list-static am-list-border">
    ...
    <li><label>联系方式</label>
    <input type="text" class="inputtip" id="mobilePhone" size="40" class="">
    </li>
			    ...
			    return false;
				  ...
				  if(handelsAre==""){
				    ...
				    $.ajax({
						...
						data:{"receivingName":receivingName,"mobilePhone":mobilePhone,"detailedAddr":detailedAddr,"isdefault":isdefault,"area":area,"areaid":area_id},
						dataType:"json",
						async:false,
