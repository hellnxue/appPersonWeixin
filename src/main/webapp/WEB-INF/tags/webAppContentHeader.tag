...
<head>
    ...
    -->
	<link href="${ctx}/static/webApp/css/page.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="${ctx}/static/webApp/js/jquery.js"></script>
	<script type="text/javascript" src="${ctx}/static/webApp/js/web.js"></script>
